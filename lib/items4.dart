...
class Items4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: MyHomePage(title: 'Furneture'),
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
            ProductBox(
                name: "New desk",
                description: "desk with a medium size perfect for studying",
                number: 0597969688,
                image: "furneture.jpg"),
            ProductBox(
                name: "Sofa",
                description:
                    "This sofa is not used a lot I just didn't like it",
                number: 0503514644,
                image: "furneture.jpg"),
          ],
        ));
